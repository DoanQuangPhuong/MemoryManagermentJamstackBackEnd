...
app.post('/allocate', (req, res) => {
  ...
  let allocations = new Array(processSizes.length).fill(-1); // Initialize allocation array
  let fragmentations = []; // Array to store fragmentation states after each allocation
  let remainingBlocks = [...blockSizes]; // Copy of block sizes to track remaining space
